    ...
    <div class="col-sm-6">
        <div class="load_msg" id="scroll_messages">
            <?php 
                ...
                while($row_msg = mysqli_fetch_array($run_msg)){
                    ...
                    <div id="loaded_msg">
                        <p><?php if($user_to == $user_to_msg AND $user_from == $user_from_msg){echo "<div class='message' id='blue' data-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br>";}  else if($user_from == $user_to_msg AND $user_to == $user_from_msg){echo" <div class='messsage' id='green' data-toggle='tooltip' title='$msg_date'>$msg_body</div><br><br><br> ";}?></p>
                    </div>
        ...
        <?php 
            if(isset($_POST['send_msg'])){
                ...
                if($msg == ""){
                    echo"<h4 style='color:red;text-align: center;'>Unable to send!</h4>";
                }else if(strlen($msg) > 1023){
                echo"<h4 style='color:red;text-align: center;'>Message is too long!Message should be under 200 characters</h4>";
            ...
            if($get_id == "new"){
                ...
                echo"
                    <div class='row'>
                        ...
                        <center>
                            <div style='background-color: #BAE4A6;' class='col-sm-9'>
