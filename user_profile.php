        ...
        if(isset($_GET['u_id'])){
            ...
            echo"
                <div class='row'>
                    ...
                    <center>
                    <div style='background-color: #7ACC54;' class='col-sm-3'>
            ...
            ?>
            <div class="col-sm-8">
                <center><h1><strong><?php echo "$f_name $l_name's"; ?></strong> Blogs</h1></center>
                <?php 
                    global $con;
                        ...
                        <div id='own_posts'>
                            <div class='row'>
                                ...
                                <div class='col-sm-6'>
                                    ...
                                    <h4><small style='color: black;'>Updated a post on<strong>$post_Date</strong></strong></small></h4>
                    ...
                    echo"
                            ...
                            <div id='own_posts'>
                                ...
                                <div class='row'>
                                    <div class='col-sm-12'>
                                    <p><large style='color:black;'>$content</large></p>                         
                                        <img id='posts-img' src='imagepost/$upload_image' style='height:350px;'>
                                    </div>
                                </div><br>
                                <a href='single.php?post_id=$post_id' style='float:right;'><button class='btn btn-success'>View</button></a>
                            ...
                            <div id='own_posts'>
                                <div class='row'>
                                    <div class='col-sm-2'>
                                        <p><img src='users/$image' class='img-circle' width='100px' height='100px'></p>
                                    </div>
                                    <div class='col-sm-6'>
                                        <h3><a style='text-decoration:none; cursor:pointer;color #3897f0;' href='user_profile.php?u_id=$user_id'>$name</a></h3>
                                        <h4><small style='color:black;'>Updated a post on <strong>$post_date</strong></small></h4>
                                    </div>
                                    <div class='col-sm-4'>
                                    </div>
                                ...
                                <div class='row'>                                   
                                    <div class='col-sm-12'>
                                    <h3><p><small style='color:black;'>$content</small></p></h3>                            
                                    </div>
                                </div><br>
